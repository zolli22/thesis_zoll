...
p_all + 
  ...
  plot_layout(ncol = 2) +
  plot_annotation(title = "health rating ~ NDVI")
...
p_type + 
  ...
  l_type +
    labs(subtitle = "LiDAR method")+
  plot_layout(ncol = 2) +
  plot_annotation(title = "health rating ~ NDVI * tree type")
...
p_species + 
  ...
  l_species +
    labs(subtitle = "LiDAR method")+
  plot_layout(ncol = 2) +
  plot_annotation(title = "health rating ~ NDVI * species")
```
...
knitr::include_graphics(c("figure/test1.png", "figure/test2.png"))
knitr::include_graphics(c("figure/test3.png", "figure/test4.png"))
knitr::include_graphics(c("figure/test5.png", "figure/test6.png"))
```
